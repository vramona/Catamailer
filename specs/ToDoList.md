...
- [x] ✅ **J0-S1-T1** - Création de l'arborescence (src, tests, scripts, docs) et de la solution Catamailer.sln avec les projets .NET 10 vides. (Validé le 07/09/2026 sur master - Commit : <COMMIT_HASH>) (Cpx: 2 / 2)
- [x] ✅ **J0-S1-T2** - Intégration et adaptation des scripts PowerShell de flux (Start-Jalon, Start-Step, Commit-Task, etc.). (Validé le 07/09/2026 sur master - Commit : <COMMIT_HASH>) (Cpx: 3 / 3)

# ⏳ CE QUI RESTE À FAIRE

## Jalon 0 - Initialisation & Outillage - chore/j0-init
### Step 1 - Workspace & Scripts - chore/j0-init_step-1-setup
- [ ] 🏗️ **J0-S1-T3** - Intégration et adaptation du script de génération de documentation AI (Ai_Architecture.md).
- [ ] 🏗️ **J0-S1-T4** - Initialisation physique des fichiers de suivi locaux (ToDoList, Specs).
