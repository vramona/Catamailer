...
- [ ] ⚪ J0-S1-T1 - Création de l'arborescence (src, tests, scripts, docs) et de la solution Catamailer.sln avec les projets .NET 10 vides.
- [ ] ⚪ J0-S1-T2 - Intégration et adaptation des scripts PowerShell de flux (Start-Jalon, Start-Step, Commit-Task, etc.).
- [ ] ⚪ J0-S1-T3 - Intégration et adaptation du script de génération de documentation AI (Ai_Architecture.md).
- [ ] ⚪ J0-S1-T4 - Initialisation physique des fichiers de suivi locaux (ToDoList, Specs).
