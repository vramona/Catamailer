...
- [x] ✅ **J2-S2-T4** - `ShadowModeService` : Comptage de télémétrie, gestion de l'activation globale `IsAutoWriteEnabled` et paliers de notification (300/600/900...). (Validé le 07/09/2026 sur feature/j2-outlook-integration_step-2-history - Commit : <COMMIT_HASH>) (Cpx: 8 / 8)
