...
- [x] ✅ `J5-S2-T3 - InsertHtmlSignature_ShouldThrowFileNotFoundException_WhenSignatureDoesNotExist` (Validé le 24/09/2026 sur feature/j5-iso-vba_step-2-infra - Commit : <COMMIT_HASH>) (Cpx: 3 / 3)
