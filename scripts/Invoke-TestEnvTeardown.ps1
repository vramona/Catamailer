<#
.SYNOPSIS
Nettoie l'environnement de test (suppression du profil et du PST) et relance Outlook sur le profil par défaut (v1.3.1).
#>
param (
...
Write-Host "[Teardown v1.3.1] 1/3 Fermeture d'Outlook (Fin des tests)..." -ForegroundColor Cyan
Stop-OutlookGracefully

Write-Host "[Teardown v1.3.1] 2/3 Suppression du profil de test..." -ForegroundColor Cyan
...
Write-Host "[Teardown v1.3.1] 3/3 Réouverture d'Outlook avec le profil par défaut : $DefaultProfile" -ForegroundColor Cyan
